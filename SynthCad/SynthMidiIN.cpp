...
bool CSynthMidiIN::Create(CSynthObject *pParent)
{
	...
	//
	//---------------------------------------
	if (false == CSynthObject::Create( CPoint()))
		return false;
...
//			CheckButtonMessages(Note, Vel);
			switch (Note)
			{
				case LK25_KNOB_TOP1:	//Attack
					PostThreadMessageW(SEID, WM_ADSR_ATTACK, Note, Vel);
					break;
				case LK25_KNOB_TOP2:	//Decay
					PostThreadMessageW(SEID, WM_ADSR_DECAY, Note, Vel);
					break;
				case LK25_KNOB_TOP3:	//Sustain
					PostThreadMessageW(SEID, WM_ADSR_SUSTAIN, Note, Vel);
					break;
				case LK25_KNOB_TOP4:	//Release
					PostThreadMessageW(SEID, WM_ADSR_RELEASE, Note, Vel);
					break;
				...
				case LK25_KNOB_TOP7:	//pwm
					PostThreadMessageW(SEID, WM_OSC_PULSEWIDTH, Note, Vel);
					break;
				case LK25_KNOB_TOP8:
